...
CREATE TABLE `tweet` (
  ...
  `media` longtext COMMENT 'Ce champs contiendras  du JSON',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,NULL,'judikaelbellance@mail.com','2000-10-19',1,'jud3v','judikael','bellance','test',0,'2024-02-19 15:34:08','2024-02-19 15:34:08');
...
-- Dump completed on 2024-02-19 16:56:17
